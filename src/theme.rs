    ...
    fn active(&self, style: &Self::Style) -> button::Appearance {
        match style {
            Button::Primary => button::Appearance {
                background: Color::from_rgb8(62, 123, 250).into(),
                border_radius: 4.0,
                border_width: 1.0,
...
impl text_input::StyleSheet for Theme {
    ...
    fn active(&self, _style: &Self::Style) -> text_input::Appearance {
        text_input::Appearance {
            background: iced::Background::Color(Color::from_rgb8(40, 41, 61)),
            border_radius: 2.0,
            border_width: 1.0,
            border_color: Color::from_rgb8(40, 41, 61),
        ...
        match style {
            Slider::Default => {
                let handle = slider::Handle {
                    ...
                    color: Color::from_rgb8(62, 123, 250),
                    border_color: Color::from_rgb8(62, 123, 250),
                    border_width: 1.0,
                };
    ...
    fn appearance(&self, style: &Self::Style) -> menu::Appearance {
        match style {
            Menu::Default => menu::Appearance {
                ...
                selected_background: iced::Background::Color(Color::from_rgb8(62, 123, 250)),
            },
        }
    }
}
